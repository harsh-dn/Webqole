export const articles = [
    ...
    {
      id: '5',
      title: 'ServiceNow introduces new version of the Now Platform',
      excerpt:
        'ServiceNow has unveiled the Now Platform Quebec release. This latest version of the Now Platform features with... ',
      body:
        'It has expanded native AI capabilities and new low-code app development tools, empowering customers to innovate quickly, realize fast time-to-value, improve productivity and deliver great experiences.',
    },
    {
      id: '6',
      title: 'Cybersecurity threats pose big challenges for businesses',
      excerpt:
